...
class GoodsCategory(models.Model):
    ...
    code = models.CharField(verbose_name='类别code',default='',max_length=30,help_text='类别coede')
    ...
    parent_category = models.ForeignKey('self',on_delete=models.CASCADE,null=True,blank=True,
                       verbose_name='父级类目',help_text='父目录',related_name='sub_cat')
...
class Goods(models.Model):
    ...
    sold_num = models.IntegerField(verbose_name='商品销量数',default=0)
